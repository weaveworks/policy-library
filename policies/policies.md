...
### ID
magalix.policies.mongodb-enforce-root-password-env-var
...
### Category
magalix.categories.access-control
...
['magalix.controls.pci-dss.2.1', 'magalix.controls.hipaa.164.312.a.1', 'magalix.controls.hipaa.164.312.a.2.i']
...
### ID
magalix.policies.mongodb-enforce-root-password-file-env-var
...
### ID
magalix.policies.block-all-egress-traffic
...
### Category
magalix.categories.network-security
...
### Standards and Controls
['magalix.controls.pci-dss.1.2.1', 'magalix.controls.nist-800-190.3.3.4', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.1']

### Tags
['pci-dss', 'mitre-attack', 'nist800-190', 'gdpr', 'soc2-type1']

### Parameters
[{'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.services-prohibit-type
...
### Standards and Controls
['magalix.controls.pci-dss.1.1.6', 'magalix.controls.pci-dss.1.3.1', 'magalix.controls.pci-dss.2.2.2']

### Tags
['pci-dss']

### Parameters
[{'name': 'type', 'type': 'string', 'required': True, 'default': 'NodePort'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mongo-express-enforce-ssl-crt-path-env-var
...
### Standards and Controls
['magalix.controls.pci-dss.1.1.6', 'magalix.controls.pci-dss.2.2.2']
...
### ID
magalix.policies.containers-sharing-host-pid
...
### Standards and Controls
['magalix.controls.cis-benchmark.5.2.4', 'magalix.controls.cis-benchmark.5.2.3', 'magalix.controls.nist-800-190.4.5.2', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24']

### Tags
['cis-benchmark', 'nist800-190', 'gdpr', 'default']

### Parameters
[{'name': 'resource_enabled', 'type': 'boolean', 'required': True, 'default': False}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.influxdb-enforce-username-env-var
...
### Category
magalix.categories.organizational-standards
...
### ID
magalix.policies.influxdb-enforce-admin-token-env-var
...
### ID
magalix.policies.mysql-enforce-onetime-password-env-var
...
### Standards and Controls
['magalix.controls.pci-dss.2.1', 'magalix.controls.hipaa.164.312.a.1', 'magalix.controls.hipaa.164.312.a.2.i', 'magalix.controls.gdpr.24', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32']
...
### ID
magalix.policies.rabbitmq-enforce-generated-config-dir-env-var
...
### ID
magalix.policies.rabbitmq-enforce-default-pass-env-var
...
### ID
magalix.policies.mariadb-enforce-mysql-database-env-var
...
### ID
magalix.policies.mongo-express-enforce-ssl-enabled-env-var
...
### ID
magalix.policies.rabbitmq-enforce-enabled-plugins-env-var
...
### ID
magalix.policies.mongodb-enforce-root-username-file-env-var
...
### ID
magalix.policies.influxdb-enforce-bucket-env-var
...
### ID
magalix.policies.container-running-as-user
...
### Parameters
[{'name': 'uid', 'type': 'integer', 'required': True, 'default': 0}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': 'kube-system'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.postgres-enforce-password-env-var
...
### Standards and Controls
['magalix.controls.hipaa.164.312.a.1', 'magalix.controls.hipaa.164.312.a.2.i', 'magalix.controls.gdpr.24', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32']
...
### ID
magalix.policies.mongo-express-enforce-request-size-env-var
...
### ID
magalix.policies.rabbitmq-enforce-plugins-expand-dir-env-var
...
### ID
magalix.policies.missing-kubernetes-app-instance-label
...
### ID
magalix.policies.mariadb-enforce-root-password-env-var
...
### ID
magalix.policies.mongo-express-enforce-admin-password-env-var
...
### ID
magalix.policies.mongo-express-enforce-mongodb-port-env-var
...
### ID
magalix.policies.block-all-ingress-traffic
...
### ID
magalix.policies.containers-block-ssh-port
...
### Parameters
[{'name': 'container_port', 'type': 'integer', 'required': True, 'default': 22}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.rabbitmq-enforce-fail-if-no-peer-cert-env-var
...
### ID
magalix.policies.postgres-enforce-initdb-waldir-env-var
...
### ID
magalix.policies.rabbitmq-enforce-mnesia-base-env-var
...
### ID
magalix.policies.rabbitmq-enforce-logs-env-var
...
### ID
magalix.policies.rabbitmq-enforce-default-vhost-env-var
...
### ID
magalix.policies.rabbitmq-enforce-vm-memory-env-var
...
### ID
magalix.policies.mariadb-enforce-password-env-var
...
### ID
magalix.policies.services-restrict-protocols
...
### Standards and Controls
['magalix.controls.pci-dss.1.1.6', 'magalix.controls.pci-dss.1.3.1', 'magalix.controls.soc2-type-i.1.6.7']

### Tags
['pci-dss', 'soc2-type1']

### Parameters
[{'name': 'protocols', 'type': 'string', 'required': True, 'default': 'HTTPS'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### Standards and Controls
['magalix.controls.pci-dss.2.2.4', 'magalix.controls.pci-dss.2.2.5', 'magalix.controls.cis-benchmark.5.2.1', 'magalix.controls.mitre-attack.4.1', 'magalix.controls.nist-800-190.3.3.1', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.1']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'nist800-190', 'gdpr', 'soc2-type1', 'default']

### Parameters
[{'name': 'privilege', 'type': 'boolean', 'required': True, 'default': False}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.containers-should-not-run-in-namespace
...
### Standards and Controls
['magalix.controls.cis-benchmark.5.7.4', 'magalix.controls.soc2-type-i.2.1.1']

### Tags
['cis-benchmark', 'soc2-type1']

### Parameters
[{'name': 'custom_namespace', 'type': 'string', 'required': True, 'default': 'default'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.disable-service-account-token-automount-in-specific-namespace
...
### Standards and Controls
['magalix.controls.pci-dss.7.1.1', 'magalix.controls.cis-benchmark.5.1.6', 'magalix.controls.mitre-attack.6.3', 'magalix.controls.hipaa.164.312.a.2.i', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.hipaa.164.312.a.1', 'magalix.controls.soc2-type-i.1.6.3']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'hipaa', 'gdpr', 'default', 'soc2-type1']

### Parameters
[{'name': 'automount', 'type': 'boolean', 'required': True, 'default': False}, {'name': 'namespace', 'type': 'string', 'required': True, 'default': 'default'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mysql-enforce-skip-tzinfo-env-var
...
### ID
magalix.policies.containers-missing-liveness-probe
...
### Category
magalix.categories.reliability
...
### ID
magalix.policies.containers-using-hostport
...
### Standards and Controls
['magalix.controls.pci-dss.2.2.2', 'magalix.controls.nist-800-190.4.4.2']

### Tags
['pci-dss', 'nist800-190']

### Parameters
[{'name': 'host_port', 'type': 'string', 'required': True, 'default': 'hostPort'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.postgres-enforce-pgdata-env-var
...
### ID
magalix.policies.rabbitmq-enforce-ssl-depth-env-var
...
### ID
magalix.policies.mariadb-enforce-mysql-root-password-env-var
...
### ID
magalix.policies.mongo-express-enforce-auth-username-env-var
...
### ID
magalix.policies.mariadb-enforce-database-env-var
...
### ID
magalix.policies.mysql-enforce-user-env-var
...
### ID
magalix.policies.mongo-express-enforce-auth-password-env-var
...
### ID
magalix.policies.missing-kubernetes-app-version-label
...
### ID
magalix.policies.mariadb-prohibit-mysql-empty-password-env-var
...
### ID
magalix.policies.mariadb-enforce-initdb-skip-tzinfo-env-var
...
### ID
magalix.policies.rabbitmq-enforce-plugins-dir-env-var
...
### ID
magalix.policies.rabbitmq-enforce-mnesia-dir-env-var
...
### ID
magalix.policies.influxdb-enforce-org-env-var
...
### ID
magalix.policies.rabbitmq-enforce-pid-file-env-var
...
### ID
magalix.policies.mysql-enforce-root-password-env-var
...
### ID
magalix.policies.mongo-express-enforce-base-url-env-var
...
### ID
magalix.policies.mariadb-enforce-mysql-user-env-var
...
### ID
magalix.policies.rabbitmq-enforce-additional-erl-args-env-var
...
### ID
magalix.policies.rabbitmq-enforce-schema-dir-env-var
...
### ID
magalix.policies.mariadb-enforce-mysql-random-root-password-env-var
...
### ID
magalix.policies.missing-owner-label
...
### ID
magalix.policies.prometheus-rbac-prohibit-verbs
...
### Standards and Controls
['magalix.controls.pci-dss.7.1.1', 'magalix.controls.pci-dss.7.1.2', 'magalix.controls.hipaa.164.312.a.1', 'magalix.controls.soc2-type-i.1.6.3']

### Tags
['pci-dss', 'hipaa', 'soc2-type1']

### Parameters
[{'name': 'prometheus_verb', 'type': 'string', 'required': True, 'default': 'put'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mongo-express-enforce-cookie-secret-env-var
...
### ID
magalix.policies.mariadb-enforce-random-root-password-env-var
...
### ID
magalix.policies.containers-running-with-unapproved-linux-capabilities
...
### Standards and Controls
['magalix.controls.pci-dss.2.2.4', 'magalix.controls.pci-dss.2.2.5', 'magalix.controls.cis-benchmark.5.2.7', 'magalix.controls.cis-benchmark.5.2.8', 'magalix.controls.cis-benchmark.5.2.9', 'magalix.controls.mitre-attack.4.1', 'magalix.controls.nist-800-190.3.3.1', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.1']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'nist800-190', 'gdpr', 'soc2-type1', 'default']

### Parameters
[{'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mongo-express-enforce-mongodb-server-env-var
...
### Standards and Controls
['magalix.controls.pci-dss.2.2.4', 'magalix.controls.pci-dss.2.2.5', 'magalix.controls.cis-benchmark.5.2.5', 'magalix.controls.mitre-attack.4.1', 'magalix.controls.nist-800-190.3.3.2', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.1']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'nist800-190', 'gdpr', 'default', 'soc2-type1']

### Parameters
[{'name': 'exclude_namespace', 'type': 'string', 'required': True, 'default': 'kube-system'}, {'name': 'allow_privilege_escalation', 'type': 'boolean', 'required': True, 'default': False}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.containers-missing-readiness-probe
...
### ID
magalix.policies.missing-kubernetes-app-component-label
...
### ID
magalix.policies.persistent-volume-reclaim-policy-should-be-set-to-retain
...
### Category
magalix.categories.data-protection
...
### Standards and Controls
['magalix.controls.pci-dss.3.1', 'magalix.controls.soc2-type-i.2.1.2']

### Tags
['pci-dss', 'soc2-type1']

### Parameters
[{'name': 'pv_policy', 'type': 'string', 'required': True, 'default': 'Retain'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.container-running-as-root
...
### ID
magalix.policies.mariadb-enforce-mysql-password-env-var
...
### ID
magalix.policies.containers-mounting-docker-socket
...
### Standards and Controls
['magalix.controls.nist-800-190.4.4.3', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24']

### Tags
['nist800-190', 'gdpr', 'default']

### Parameters
[{'name': 'docker_sock', 'type': 'string', 'required': True, 'default': 'docker.sock'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.controller-serviceaccount-tokens-automount
...
### Standards and Controls
['magalix.controls.pci-dss.7.2.1', 'magalix.controls.cis-benchmark.5.1.5', 'magalix.controls.mitre-attack.1.4', 'magalix.controls.hipaa.164.312.a.2.i', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.3']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'hipaa', 'gdpr', 'default', 'soc2-type1']

### Parameters
[{'name': 'automount_token', 'type': 'boolean', 'required': True, 'default': False}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mongo-express-enforce-session-secret-env-var
...
### ID
magalix.policies.mariadb-enforce-mysql-initdb-skip-tzinfo-env-var
...
### ID
magalix.policies.rabbitmq-enforce-ssl-verify-env-var
...
### ID
magalix.policies.mongo-express-enforce-enable-admin-env-var
...
### ID
magalix.policies.rabbitmq-enforce-config-file-env-var
...
### ID
magalix.policies.mongo-express-enforce-admin-username-env-var
...
### ID
magalix.policies.mysql-enforce-database-env-var
...
### ID
magalix.policies.prohibit-naked-pods-from-being-scheduled
...
### ID
magalix.policies.mariadb-prohibit-empty-password-env-var
...
### ID
magalix.policies.missing-kubernetes-app-part-of-label
...
### ID
magalix.policies.containers-sharing-process-namespace
...
### ID
magalix.policies.containers-should-not-run-on-kubernetes-control-plane-nodes
...
### Category
magalix.categories.capacity-management
...
### Standards and Controls
['magalix.controls.soc2-type-i.2.1.1']

### Tags
['soc2-type1']

### Parameters
[{'name': 'toleration_key', 'type': 'string', 'required': True, 'default': 'node-role.kubernetes.io/master'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.prohibit-creating-namespace-starting-with-prefix
...
### Parameters
[{'name': 'namespace_name', 'type': 'string', 'required': True, 'default': 'kube-'}]
...
### ID
magalix.policies.missing-kubernetes-app-created-by-label
...
### ID
magalix.policies.rabbitmq-enforce-ssl-keyfile-env-var
...
### ID
magalix.policies.influxdb-enforce-retention-env-var
...
### ID
magalix.policies.containers-sharing-host-ipc
...
### ID
magalix.policies.containers-read-only-root-filesystem
...
### Standards and Controls
['magalix.controls.mitre-attack.3.2', 'magalix.controls.nist-800-190.4.4.4']

### Tags
['mitre-attack', 'nist800-190']

### Parameters
[{'name': 'read_only', 'type': 'boolean', 'required': True, 'default': True}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.missing-kubernetes-app-label
...
### ID
magalix.policies.postgres-enforce-auth-method-env-var
...
### ID
magalix.policies.mongo-express-enforce-editor-theme-env-var
...
### ID
magalix.policies.container-image-pull-policy
...
### Category
magalix.categories.software-supply-chain
...
### Parameters
[{'name': 'policy', 'type': 'string', 'required': True, 'default': 'Always'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mysql-prohibit-empty-password-env-var
...
### Standards and Controls
['magalix.controls.pci-dss.2.1', 'magalix.controls.hipaa.164.312.a.2.i']
...
### ID
magalix.policies.container-prohibit-image-tag
...
### Standards and Controls
['magalix.controls.cis-benchmark.5.5.1', 'magalix.controls.mitre-attack.1.2', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.soc2-type-i.1.6.8']

### Tags
['cis-benchmark', 'mitre-attack', 'gdpr', 'soc2-type1', 'default']

### Parameters
[{'name': 'image_tag', 'type': 'string', 'required': True, 'default': 'latest'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mysql-enforce-random-root-password-env-var
...
### ID
magalix.policies.postgres-enforce-initdb-args-env-var
...
### ID
magalix.policies.containers-not-using-runtime-default-seccomp-profile
...
### Standards and Controls
['magalix.controls.cis-benchmark.5.7.2', 'magalix.controls.nist-800-190.4.4.3', 'magalix.controls.soc2-type-i.1.6.1']

### Tags
['cis-benchmark', 'nist800-190', 'soc2-type1']

### Parameters
[{'name': 'seccomp_annotation', 'type': 'string', 'required': True, 'default': 'runtime/default'}, {'name': 'seccomp_type', 'type': 'string', 'required': True, 'default': 'RuntimeDefault'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.rabbitmq-enforce-log-base-env-var
...
### ID
magalix.policies.mongo-express-enforce-ssl-key-path-env-var
...
### ID
magalix.policies.influxdb-enforce-password-env-var
...
### ID
magalix.policies.block-workloads-created-without-specifying-namespace
...
### Parameters
[{'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mysql-enforce-password-env-var
...
### ID
magalix.policies.containers-missing-startup-probe
...
### ID
magalix.policies.mongodb-enforce-database-env-var
...
### ID
magalix.policies.services-prohibit-ports-range
...
### Parameters
[{'name': 'target_port', 'type': 'integer', 'required': True, 'default': 1024}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.rabbitmq-enforce-ssl-ca-cert-file-env-var
...
### ID
magalix.policies.containers-missing-security-context
...
### ID
magalix.policies.rbac-protect-cluster-admin-clusterrolebindings
...
### Standards and Controls
['magalix.controls.pci-dss.7.1.1', 'magalix.controls.pci-dss.7.1.2', 'magalix.controls.cis-benchmark.5.1.1', 'magalix.controls.mitre-attack.4.2', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24', 'magalix.controls.hipaa.164.312.a.1', 'magalix.controls.soc2-type-i.1.6.3']

### Tags
['pci-dss', 'cis-benchmark', 'mitre-attack', 'gdpr', 'hipaa', 'soc2-type1']

### Parameters
[{'name': 'subjects_name', 'type': 'string', 'required': True, 'default': 'system:masters'}, {'name': 'subjects_kind', 'type': 'string', 'required': True, 'default': 'Group'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.containers-enforce-restart-policy
...
### Parameters
[{'name': 'restart_policy', 'type': 'string', 'required': True, 'default': 'Always'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.containers-block-ports-range
...
### Standards and Controls
['magalix.controls.pci-dss.1.1.6', 'magalix.controls.pci-dss.2.2.2', 'magalix.controls.nist-800-190.4.4.2']
...
### ID
magalix.policies.mariadb-enforce-user-env-var
...
### ID
magalix.policies.prometheus-clusterrolebinding-has-incorrect-bindings
...
### Parameters
[{'name': 'prometheus_subject_name', 'type': 'string', 'required': True, 'default': 'prometheus'}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.postgres-enforce-user-env-var
...
### ID
magalix.policies.rabbitmq-enforce-default-user-env-var
...
### ID
magalix.policies.missing-kubernetes-app-managed-by-label
...
### ID
magalix.policies.rabbitmq-enforce-ssl-cert-file-env-var
...
### ID
magalix.policies.containers-using-hostpath
...
### Standards and Controls
['magalix.controls.mitre-attack.3.2', 'magalix.controls.nist-800-190.4.4.5', 'magalix.controls.gdpr.25', 'magalix.controls.gdpr.32', 'magalix.controls.gdpr.24']

### Tags
['mitre-attack', 'nist800-190', 'gdpr', 'default']

### Parameters
[{'name': 'hostpath_key', 'type': 'string', 'required': True, 'default': 'hostPath'}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.postgres-enforce-db-env-var
...
### Targets
{'kind': ['Deployment', 'ReplicationController', 'ReplicaSet', 'StatefulSet']}
...
### Parameters
[{'name': 'replica_count', 'type': 'integer', 'required': True, 'default': 2}, {'name': 'exclude_namespace', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_key', 'type': 'string', 'required': False, 'default': None}, {'name': 'exclude_label_value', 'type': 'string', 'required': False, 'default': None}]
...
### ID
magalix.policies.mongodb-enforce-root-username-env-var
...
### ID
magalix.policies.containers-sharing-host-network

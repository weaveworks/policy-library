...
CATEGORIES_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "categories")
...
@sync.command()
@click.option("--categories-dir", "-d", required=True, default=CATEGORIES_DIR, help="Categories directory")
@click.option("--magalix-account", "-a", required=True, default=MAGALIX_ACCOUNT, help="Magalix account ID")
@click.option("--policies-service", "-s", required=True, default=POLICIES_SVC_URL, help="Policies Service url")
